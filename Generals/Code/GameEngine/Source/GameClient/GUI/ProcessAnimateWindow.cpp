...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initAnimateWindow( CNCAnimateWindow *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRight::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromLeft::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromLeft::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromLeft::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromLeft::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromTop::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTop::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTop::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTop::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromBottom::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromBottom::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottom::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottom::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromBottomTimed::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
void ProcessAnimateWindowSlideFromBottomTimed::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottomTimed::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottomTimed::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
void ProcessAnimateWindowSlideFromTopFast::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTopFast::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTopFast::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTopFast::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initAnimateWindow( CNCAnimateWindow *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D size = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRightFast::updateAnimateWindow( CNCAnimateWindow *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRightFast::reverseAnimateWindow( CNCAnimateWindow *animWin )
{
