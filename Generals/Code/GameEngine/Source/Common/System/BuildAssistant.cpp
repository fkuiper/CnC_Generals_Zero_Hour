																											 ...
																											 Player *player)
{
	...
	if(CNC_BitTest( options, SHROUD_REVEALED ) )
	{
		{
			Int x, y;
	...
	//
	if(CNC_BitTest( options, NO_OBJECT_OVERLAP ) )
	{
	...
	//
	if(CNC_BitTest( options, NO_ENEMY_OBJECT_OVERLAP ) )
	{
	...
	if(CNC_BitTest( options, CLEAR_PATH ) && builderObject )
	{
		...
		//
		if(CNC_BitTest( options, USE_QUICK_PATHFIND ) )
		{
