...
{ 
	...
	if(CNC_BitTest( obj->getStatusBits(), OBJECT_STATUS_UNDER_CONSTRUCTION ) == FALSE )
	{
...
{
	return CNC_BitTest( m_upgradesCompleted, testMask );
}
...
{
	Int64 testMask = upgradeTemplate->getUpgradeMask();
	return CNC_BitTest( m_upgradesInProgress, testMask );
}
