...
//						Then setup each of the virtual classes to process an CNCAnimateWindow
...
public:
	...
	virtual void initAnimateWindow( CNCAnimateWindow *animWin ) = 0;
	virtual void initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay = 0 ) = 0;
	virtual Bool updateAnimateWindow( CNCAnimateWindow *animWin ) = 0;
	virtual Bool reverseAnimateWindow( CNCAnimateWindow *animWin ) = 0;
...
public:
	...
	virtual void initAnimateWindow( CNCAnimateWindow *animWin );
	virtual void initReverseAnimateWindow( CNCAnimateWindow *animWin, UnsignedInt maxDelay = 0 );
	virtual Bool updateAnimateWindow( CNCAnimateWindow *animWin );
	virtual Bool reverseAnimateWindow( CNCAnimateWindow *animWin );
private:
